...
import bwie.com.jingdong.View.activity.MainActivity;
import bwie.com.jingdong.View.activity.MainActivity_02;
import bwie.com.jingdong.View.holder.FenLeiRecyclerOutHolder;
    ...
    public void onBindViewHolder(FenLeiRecyclerOutHolder holder, int position) {
        ...
        fenRecyclerInnerAdapter.setOnItemListner(new OnItemListner() {
            ...
            public void onItemClick(int i) {
                ...
                Intent intent = new Intent(context, MainActivity_02.class);
