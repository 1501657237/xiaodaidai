...
import bwie.com.jingdong.Presenter.UserInfoPresenter;
...
public class UserInfoActivity extends AppCompatActivity  implements View.OnClickListener ,UpLoadActivityInter,UserInforInter {
    ...
    private void initData() {
     ...
     //  GlideImgManager.glideLoader(UserInfoActivity.this, CommonUtils.getString("iconUrl"), R.drawable.user, R.drawable.user, setting_icon, 0);
        Glide.with(UserInfoActivity.this).load(CommonUtils.getString("iconUrl")).asBitmap().centerCrop().into(new BitmapImageViewTarget(setting_icon) {
            @Override
            protected void setResource(Bitmap resource) {
                RoundedBitmapDrawable circularBitmapDrawable =
                        RoundedBitmapDrawableFactory.create(UserInfoActivity.this.getResources(), resource);
    ...
    @Override
    public void onUserInforSuccess(final UserInfoBean userInfoBean) {
    ...
    @Override
    public void uploadPicSuccess(final UpLoadPicBean upLoadPicBean) {
              runOnUiThread(new Runnable() {
                  @Override
                  public void run() {
