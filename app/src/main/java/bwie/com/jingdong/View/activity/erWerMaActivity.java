...
public class erWerMaActivity extends AppCompatActivity {

    private CheckBox deng;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.erweima_layout);
        deng = (CheckBox) findViewById(R.id.deng);
    ...
    CodeUtils.AnalyzeCallback analyzeCallback = new CodeUtils.AnalyzeCallback() {
        ...
        public void onAnalyzeSuccess(Bitmap mBitmap, String result) {
            ...
            erWerMaActivity.this.setResult(RESULT_OK, resultIntent);
            erWerMaActivity.this.finish();
        }
