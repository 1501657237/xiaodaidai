...
import bwie.com.jingdong.Presenter.CreateOrderPresenter;
import bwie.com.jingdong.Presenter.GetDefaultAddrPresenter;
import bwie.com.jingdong.R;
import bwie.com.jingdong.View.Adapter.SureOrderAdapter;
...
public class MakeSureOrderActivity  extends AppCompatActivity  implements View.OnClickListener,CreateOrderInter,DefaultAddrInter {
    ...
    @Override
     public void onCreateOrderSuccess(final CreateOrderBean createOrderBean) {
     ...
     */
    @Override
    public void onGetDefaultAddrSuccess(final DefaultAddrBean defaultAddrBean) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                //显示地址...设置适配器
