...
import bwie.com.jingdong.Presenter.FragmentCartPresenter;
import bwie.com.jingdong.Presenter.FragmentHomeP;
import bwie.com.jingdong.R;
import bwie.com.jingdong.View.Adapter.MyExpanableAdapter;
...
import bwie.com.jingdong.View.Iview.MyExpanableView;
...
public class FragmentShoppingCart extends Fragment implements InterFragmentHome, FragmentCartInter, View.OnClickListener {
    ...
    private static RelativeLayout relative_progress;
    private static FragmentCartPresenter fragmentCartPresenter;
    ...
    public void getCartDataNull() {
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                empty_cart_image.setVisibility(View.VISIBLE);
                num_text.setText("购物车（0)");
                //去显示价格和数量
                String priceString = decimalFormat.format(0);
                CountPriceBean countPriceBean = new CountPriceBean(priceString,0);
    ...
    public void getCartDataSuccess(final CartBean cartBean) {
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                num_text.setText("购物车（" + cartBean.getData().size() + ")");
