package bwie.com.jingdong.util;

import android.content.SharedPreferences;

import bwie.com.jingdong.Application.App;
...
public class CommonUtils {
    ...
    public static void saveString(String flag, String str) {
        if (sharedPreferences == null) {
            sharedPreferences = App.getAppContext().getSharedPreferences(TAG, App.getAppContext().MODE_PRIVATE);
        }
